...
namespace spec\Al\ResourceManagement\Infrastructure\Persistence\Doctrine\Fixtures;

use Al\ResourceManagement\Infrastructure\Persistence\Doctrine\Fixtures\FileLocator;
...
class FileLocatorSpec extends ObjectBehavior
{
    ...
    {
        $path = __DIR__.'/../../../../../../src/ResourceManagement/Infrastructure/Persistence/Doctrine/Resources/fixtures/employee.yml';
